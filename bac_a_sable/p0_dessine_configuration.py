...
from app.utils.gestion_json 						import sauvFicJson, chargFicJson
from app.classes.classe_Grille_de_cases 			import Grille_de_cases
from app.classes. classe_definition_amphitheatre	import definition_amphitheatre
