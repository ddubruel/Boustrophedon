...
#             self.grilles = data["grilles"]
    ...
    def _init_interface(self):
        ...
        btn_sauv = tk.Button(self.scroll_frame, text="Sauvegarde de cette configuration.",
        ...
        tk.Button(self.scroll_frame,
                  text="Valider cette configuration et passer à la suite.",
                  command = self.validationConfiguration ).pack(padx=100)
...
#         return listeCasesCocheesPourToutesLesZones, nb_places, Nb_rang, nomAmphi
    ...
    def _compterCasesCochees(self):
        ...
        print(f"Le total de cases cochées est de {nb}")
    
    def validationConfiguration(self):
        # récupération à la liste des cases cochées (les coordonnées (ligne,colonne) en liste)
        # fonction importée
        self.data["casesCochees"] = extraction_liste_cases_cochees( self.grillesDeZone ,  self.data["amphi"])       
...
if __name__=='__main__':
    ...
    root=tk.Tk()
    graphiqueGrilleAmphi(root,data)
